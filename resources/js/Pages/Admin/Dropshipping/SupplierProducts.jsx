...
export default function SupplierProducts({ products = [], suppliers = [], categories = [], stock_filter = 'all', stock_operator = '', stock_value = '', category_filter = '', search_filter = '', status_filter = '', import_status_filter = '', order_by = 'newest', pagination = {} }) {
  ...
  const clearFilters = () => { setSearch(''); setOperator(''); setValue(''); setCategory(''); setStatus(''); setOrderBy('newest'); setPageSize('100'); setSelected([]); router.get('/admin/dropshipping/products?per_page=100', {}, { preserveState: true, preserveScroll: true }); };
