...
class SettingController extends Controller
{
    ...
    private function rulesForSection(string $section): array
    {
        return match ($section) {
            ...
            'theme' => [
                ...
                'template_2_hero_overlay_color' => ['nullable', 'string', 'max:20', 'regex:/^#[0-9A-Fa-f]{6}$/'],
                'template_2_hero_overlay_opacity' => ['nullable', 'numeric', 'min:0', 'max:80'],
    ...
    private function persistSection(string $section, array $data, Request $request): void
    {
        ...
        $keys = match ($section) {
            'brand' => [
                'site_name', 'tagline', 'header_logo_height', 'header_title_size', 'header_tagline_size',
                'footer_text', 'footer_copyright_text', 'footer_copyright_url',
